...
<head>
    <title>Diabuddy User Profile</title>
    <!-- Required meta tags -->
    <meta charset="utf-8">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-3 col-xl-2 col-md-4 sidebar fixed-top">
                        ...
                        <ul class="navbar-nav flex-column mt-4">
                            ...
                            <li class="nav-item">
                                <a href="<?php echo base_url('AdminContr/viewAllUserRecords'); ?>" class="nav-link text-light p-3 mb-2 current"> <i class="fa fa-user text-light fa-lg mr-3" aria-hidden="true"></i> User List
                                </a>
                            </li>
                            <li class="nav-item">
                    ...
                    ?>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><?php echo $record->Age_Range?></td>
                                    <td><?php echo $record->Physical_Activity?></td>
                                    <td><?php echo $record->cal_plan?></td>
                                    <td>
                                            <a href="<?php echo base_url('AdminContr/deleteUser/'.$record->ID);?>" class="btn btn-danger btn-delete"
