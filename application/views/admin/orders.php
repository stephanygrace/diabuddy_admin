                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td style="width: 130px;">
                                            <a href="<?php echo base_url('AdminContr/editRecipeRecord/'.$record->ID);?>" class="btn btn-edit"><i class="fa-solid fa-pen-to-square"></i></a>
                                            <a href="<?php echo base_url('AdminContr/deleteRecipe/'.$record->ID);?>" class="btn btn-danger btn-delete"
                                                onCLick="return confirm('Are you sure you want to Delete this Recipe?')"><i class="fa-solid fa-trash"></i></a>
                                        </td>
                                    </tr>
                                    <?php
                                        }
