                ...
                <div class="row">
                    ...
                    <div class="col-lg-3 col-xl-2 col-md-4 sidebar fixed-top">
                        ...
                        <ul class="navbar-nav flex-column mt-4">
                            ...
                            <li class="nav-item">
                                <a href="<?php echo base_url('AdminContr/viewAllProcess'); ?>" class="nav-link text-light p-3 mb-2 sidebar-link"> <i class="fa fa-spinner text-light fa-lg mr-3" aria-hidden="true"></i> In-Process
                                </a>
                            </li>
                            <li class="nav-item">
                                <a href="<?php echo base_url('AdminContr/viewAllDeliverRecords'); ?>" class="nav-link text-light p-3 mb-2 current"> <i class="fa fa-motorcycle text-light fa-lg mr-3" aria-hidden="true"></i> Delivery
                                </a>
                            </li>
                            <li class="nav-item">
                                <a href="<?php echo base_url('AdminContr/viewRecordHistory'); ?>" class="nav-link text-light p-3 mb-2 sidebar-link"> <i class="fa fa-history text-light fa-lg mr-3" aria-hidden="true"></i> Order History
                                </a>
                            </li>
                            <li class="nav-item">
                    ...
                    <div class="top-navbar">
                        <div class="row align-items-center">
                            <div class="brand">
                                <img src="<?php echo base_url('assets/dblogo.png'); ?>" width="130px;" class="rounded-circle mr-1">
                            </div>
                            ...
                            <table class="table table-bordered">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><?php echo $record->deliverschedule?></td>
                                        <td><?php echo $record->specialinstructions?></td>
                                        <td><?php echo "₱".number_format($record->total)?></td> 
                                        <td>
                                            <a href="<?php echo base_url('AdminContr/deleteDelivery/'.$record->id); ?>" class="btn btn-danger" onclick="return confirm('Are you sure you want to end the process?');" >Done</a>
                                        </td>
                                    </tr>
                                    <?php
                                        }
